...
export default function ContactSection({styles}) {
  return <div id='contact' className='mx-auto' style={{width:"95%", marginTop:50}}>
        ...
        <p style={{color: styles.accentTextColor, textAlign:'center'}} className='mono-font'>Although I'm not currently looking for any new opportunities, my inbox is always open. </p>
