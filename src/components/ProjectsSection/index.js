  ...
  return (
    ...
    >
      ...
      <Project
        ...
        >
          <p style={{ color: styles.accentTextColor }} className="mono-font">
            A package that allows developers to add native drag and drop support
        ...
        >
          <p
            className="text-end mono-font"
            style={{ color: styles.accentTextColor }}
          >
            A store for all your dragon related needs! Dragazon is a MERN
            e-commerce application created by Lonnie Mitchell, Chris Garrison,
            and I.
          </p>
        </Project>
        <Project
        ...
        >
          <p style={{ color: styles.accentTextColor }} className="mono-font">
            A password generator built with React and Bootstrap.{" "}
          </p>
        </Project>
        <Project
          left
        ...
        >
          <p
            ...
            style={{ color: styles.accentTextColor }}
          >
            Back in 2015, my friend, Jacob and I created our first iOS app
            called Let's Do This. The app was a car rampage game, where the user
