...
export default function CrazyFaceIcon(props) {
  return <div>
    ...
    <path
      fill="#F4F7F9"
      d="M29.284 9.012a6.734 6.734 0 1 1-13.169 2.821 6.734 6.734 0 0 1 13.169-2.821z"
    />
    <circle fill="#292F33" cx={22.306} cy={9.291} r={2.037} />
    <path
      fill="#F4F7F9"
      d="M14.088 14.282a3.938 3.938 0 1 1-7.7 1.65 3.938 3.938 0 0 1 7.7-1.65z"
    />
    <circle
    ...
    <path
      fill="#DD2F45"
      d="M17 31.883a.545.545 0 0 0 .545-.545v-6.295h-1.091v6.295a.546.546 0 0 0 .546.545z"
    />
    <path
      fill="#FFF"
